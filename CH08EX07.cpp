...
void copyArray(int list1[], int src, int list2[],
    ...
    int main()
    {
        ...
        //Line 15 Find and output the largest element in listA
        cout << "Line 16: The largest element in "
        << "listA is: "
        << listA[indexLargestElement(listA, ARRAY_SIZE)]
        << endl << endl; 
        
        //Line 16 Copy the elements of listA into listB using the function copyArray
        copyArray(listA, 0, listB, 0, ARRAY_SIZE); //Line 17
        cout << "Line 18: After copying the elements "
        << "of listA into listB," << endl << " listB elements are: "; //Line 18 Output the elements of listB
